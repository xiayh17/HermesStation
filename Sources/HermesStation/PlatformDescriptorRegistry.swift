    ...
    static let allPlatforms: [PlatformDescriptor] = [
        ...
        .init(
            ...
            setupInstructions: [
                ...
                "5. NetEase 163/188 may still reject INBOX with 'Unsafe Login' even after IMAP is enabled; that is a mailbox-side security block, not just a missing field.",
            ],
            fields: [
                ...
                .init(key: "EMAIL_IMAP_SEND_ID", label: "IMAP ID policy", isSecret: false, isAllowlist: false, helpText: "auto, always, or never. 163/188 often need IMAP ID before INBOX access.", defaultValue: "auto"),
                .init(key: "EMAIL_IMAP_ID_NAME", label: "IMAP client name", isSecret: false, isAllowlist: false, helpText: "Optional ID name sent after login. Default Hermes Agent.", defaultValue: "Hermes Agent"),
                .init(key: "EMAIL_IMAP_ID_VENDOR", label: "IMAP client vendor", isSecret: false, isAllowlist: false, helpText: "Optional ID vendor sent after login. Default HermesStation.", defaultValue: "HermesStation"),
                ...
                .init(key: "EMAIL_SMTP_SECURITY", label: "SMTP security", isSecret: false, isAllowlist: false, helpText: "auto, starttls, ssl, or plain. 465 should usually use ssl.", defaultValue: "auto"),
        ...
        .init(
            ...
            fields: [
                ...
                .init(key: "FEISHU_GROUP_POLICY", label: "Group policy", isSecret: false, isAllowlist: false, helpText: "open, allowlist, or disabled.", defaultValue: "allowlist"),
                .init(key: "FEISHU_WEBHOOK_HOST", label: "Webhook host", isSecret: false, isAllowlist: false, helpText: "Default 127.0.0.1 for webhook mode.", defaultValue: "127.0.0.1"),
                .init(key: "FEISHU_WEBHOOK_PORT", label: "Webhook port", isSecret: false, isAllowlist: false, helpText: "Default 8765 for webhook mode.", defaultValue: "8765"),
                .init(key: "FEISHU_WEBHOOK_PATH", label: "Webhook path", isSecret: false, isAllowlist: false, helpText: "Default /feishu/webhook for webhook mode.", defaultValue: "/feishu/webhook"),
                .init(key: "FEISHU_ENCRYPT_KEY", label: "Encrypt key", isSecret: true, isAllowlist: false, helpText: "Webhook signature verification key.", defaultValue: nil),
                .init(key: "FEISHU_VERIFICATION_TOKEN", label: "Verification token", isSecret: true, isAllowlist: false, helpText: "Webhook payload verification token.", defaultValue: nil),
                ...
                .init(key: "FEISHU_BOT_OPEN_ID", label: "Bot open_id", isSecret: false, isAllowlist: false, helpText: "Optional explicit bot open_id for @mention gating.", defaultValue: nil),
                .init(key: "FEISHU_BOT_USER_ID", label: "Bot user_id", isSecret: false, isAllowlist: false, helpText: "Optional explicit bot user_id.", defaultValue: nil),
                .init(key: "FEISHU_BOT_NAME", label: "Bot display name", isSecret: false, isAllowlist: false, helpText: "Optional explicit bot name.", defaultValue: nil),
                ...
                .init(key: "FEISHU_HOME_CHANNEL_NAME", label: "Home chat label", isSecret: false, isAllowlist: false, helpText: "Display name for the home chat.", defaultValue: "Home"),
            ],
            specialDiscovery: .default
        ),
        .init(
